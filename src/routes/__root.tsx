  ...
  head: () => ({
    meta: [
      ...
      { title: "Nosky HomeOS — Smart Living. Seamlessly Connected." },
      {
        name: "description",
        content:
          "Nosky HomeOS is a luxury smart-home operating system by Nosky Tech. Control rooms, devices, automation and analytics from one seamless dashboard.",
      },
      ...
      { property: "og:title", content: "Nosky HomeOS — Smart Living. Seamlessly Connected." },
      {
        ...
        content: "A luxury smart-home operating system by Nosky Tech.",
      },
