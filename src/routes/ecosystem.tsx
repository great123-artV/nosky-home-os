...
import { LayoutDashboard, LogOut, ShieldCheck, Mail, ArrowRight } from "lucide-react";
...
function EcosystemScreen() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col justify-center py-12 px-4 sm:px-6 max-w-lg mx-auto">
      <motion.div
      ...
      >
        ...
        <div className="mt-8 space-y-4">
          ...
          >
            ...
            Open Existing SMART WATT Dashboard
