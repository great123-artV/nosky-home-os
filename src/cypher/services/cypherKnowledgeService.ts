...
const structuredKnowledge: KnowledgeItem[] = [
  {
    ...
    spokenAnswer: knowledgeData.company.description,
  ...
  },
  {
    ...
    spokenAnswer: `NoskyTech's mission is ${knowledgeData.company.mission} and our vision is ${knowledgeData.company.vision}`,
  ...
  },
  {
    ...
    spokenAnswer: `${knowledgeData.products.smart_watt.description} The current version controls one bulb through an ESP32 connected relay.`,
  ...
  },
  {
    ...
    spokenAnswer: `I am Cypher, the NoskyTech voice assistant. I can control supported devices, report their status, guide users, and answer approved questions about NoskyTech.`,
  ...
  },
  {
    ...
    spokenAnswer: knowledgeData.safety.voice_response,
  ...
  },
  {
    ...
    spokenAnswer: "To install SMART WATT as a mobile app, open your browser's share or settings menu and select 'Add to Home Screen'.",
    source: "PWA Standard",
    lastReviewed: "2026-07-17",
    allowedBeforeLogin: true,
  ...
  },
  {
    ...
    spokenAnswer: "Your SMART WATT device is pre-paired with your account. You can configure and view physical connection state in the Settings tab.",
    source: "Setup Manual",
    lastReviewed: "2026-07-17",
