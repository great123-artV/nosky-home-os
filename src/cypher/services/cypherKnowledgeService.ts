...
const structuredKnowledge: KnowledgeItem[] = [
  ...
  {
    id: "nosky_smart_capabilities",
    category: "company",
    title: "Nosky Smart Capabilities",
    aliases: ["what can nosky smart do", "nosky smart capabilities", "features of nosky smart"],
    keywords: ["nosky smart", "capabilities", "features", "do", "perform"],
    shortAnswer: "Nosky Smart lets you manage energy diagnostics, real-time device control, automated scene scheduling, and offline-first Cypher intelligence.",
    fullAnswer: "Nosky Smart is a centralized controller for all your NoskyTech devices. It enables bank-grade secure cloud streams, offline P2P local interactions, granular telemetry analysis, and complete voice orchestration via Cypher.",
    spokenAnswer: "Nosky Smart lets you control and monitor all your NoskyTech devices with premium telemetry, scheduling, and offline Cypher voice controls.",
    source: "Nosky Smart Documentation",
    lastReviewed: "2026-07-17",
    allowedBeforeLogin: true,
    relatedTopics: ["about", "automation"],
  },
  {
    id: "automation_how",
    category: "products",
    title: "How Automation Works",
    aliases: ["how does automation work", "explain automation", "set up automation"],
    keywords: ["automation", "work", "rules", "triggers", "scenes"],
    shortAnswer: "Automation coordinates device relays based on custom schedules, telemetry events, or ambient environmental signals.",
    fullAnswer: "Ecosystem automations run either locally on your ESP32 microcontrollers or securely via our cloud database channel. This allows your SMART WATT node to execute smart load-shedding sequences even when the internet goes offline.",
    spokenAnswer: "Automations run both locally and in the cloud to coordinate your devices using custom triggers, environmental signals, or voice rules.",
    source: "Automation Manual",
    lastReviewed: "2026-07-17",
    allowedBeforeLogin: true,
    relatedTopics: ["smart_watt", "about"],
  },
  {
    id: "device_setup",
